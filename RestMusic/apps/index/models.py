...
class Comment(models.Model):
    ...
    # 删除的时候不做任何事情
    user = models.ForeignKey(UserProfile,verbose_name='评论用户',max_length=20,on_delete=models.CASCADE,related_name='user_comment')
    song = models.ForeignKey(Song,on_delete=models.CASCADE,verbose_name='歌名',related_name='song_comment')
